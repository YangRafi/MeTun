...
exports.createProfile = async (req, res) => {
  try {
    ...
    // Ścieżka do zdjęcia, jeśli przesłano plik przez multer
    ...
    // Sprawdź, czy już istnieje profil
...
exports.updateProfile = async (req, res) => {
  try {
    ...
    if (req.file) {
      profile.profile_picture = `/uploads/profile_pictures/${req.file.filename}`;
    }

    // Uaktualnij pozostałe dane
