...
async function seed() {
    try {
        ...
        const uni1 = await University.create({ university_name: "Politechnika Białostocka", location: "Białystok", type: "Publiczna" });
        const uni2 = await University.create({ university_name: "Uniwersytet Warszawski", location: "Warszawa", type: "Publiczna" });
